...
def train(backbone="SimCLR", BATCH_SIZE=4, NUM_WORKERS=2, SHUFFLE=True, DATASET_PATH="./labeled_data/", EPOCHS=10, LR=0.001, MOM=0.9, DECAY=0.0005, print_freq=10, verbose=True):
    ...
    validation_dataset, validation_dataloader = labeled_dataloader(BATCH_SIZE, NUM_WORKERS, SHUFFLE, DATASET_PATH, SPLIT="validtion")
    ...
    for epoch in range(EPOCHS):
        ...
        lr_scheduler.step()
        eval.evaluate(model, validation_dataloader, device)
