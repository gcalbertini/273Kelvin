...
def main():
    ...
    parser.add_argument('-bs', '--batch_size', default=32, type=int, metavar='BATCH_SIZE', help='Batch size to use; default is 32')
    ...
    parser.add_argument('-p', '--print_freq', default=100, metavar='PRINT_FREQ', type=int, help="Default print frequency")
