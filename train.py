...
def train(backbone="SimCLR", BATCH_SIZE=32, NUM_WORKERS=cpu_count()//2, SHUFFLE=False, DATASET_PATH="/labeled/labeled", EPOCHS=1, LR=0.0008, MOM=0.9, DECAY=0.0005, print_freq=10, verbose=False):
